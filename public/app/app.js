...
angular.module('app').config(function($routeProvider, $locationProvider) {
    ...
    $routeProvider
        ...
        .when('/release/:projectId', { templateUrl: '/partials/release/view-releases', controller: "mvViewReleasesCtrl" })
        ...
        .when('/project', { templateUrl: '/partials/project/view-all-projects', controller: "mvProjectCtrl"})
        .when('/project/create', { templateUrl: '/partials/project/create-project', controller: "mvProjectCtrl"})
        .when('/project/:projectId', { templateUrl: '/partials/project/view-project', controller: "mvProjectCtrl"})
