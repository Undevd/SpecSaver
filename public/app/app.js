...
angular.module('app').config(function($routeProvider, $locationProvider) {
    ...
    $routeProvider
        ...
        .when('/p/:projectCode/r/:releaseCode/f', { templateUrl: '/partials/feature/views/view-release-features', controller: "ctrlViewReleaseFeatures" })
        .when('/p/:projectCode/f', { templateUrl: '/partials/feature/views/view-project-features', controller: "ctrlViewProjectFeatures" })
